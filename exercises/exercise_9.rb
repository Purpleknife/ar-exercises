...
# Restrict users from deleting (aka destroying) store records
# for stores that have 1 or more employees.
...
@store1 = Store.find(1)
if @store1.destroy && @store1.employees.size == 0
...
# => Empty stores cannot be created anyways because of the validations we added to store.rb